<script>
	...
	export const binx = {
		title: `<b>BINX</b><br />"<i>THE BAND MOM</i>"`,
		...
		pic: 'https://pbs.twimg.com/profile_images/1577684445833953281/SGrq5Coy_400x400.jpg'
	};
</script>
			...
			>
				<div class="sm:text-center lg:text-left">
					...
					<div class="flex justify-center">
						<img src={binx.pic} alt="Founder's image" class="rounded-full w-48 h-48" />
					</div>
