<script>
	const text = {
		p1: `<p>If your reading this, you've discovered something in the venue that that holds a unique digital collectible for Third Planet Studio's first ever live in person music and art festival!!</p><br><p>Each one is a digital masterpiece crafted by a Third Planet Studio Designer, waiting to be claimed by the most determined hunters.</p><br><p>When you find an egg, you'll not only add a unique piece to your digital collection but also earn bragging rights as a master Third Planet egg hunter!</p>`,
		p2: `<p>So, are you ready to crack the code?</p><br><p>Unravel the mysteries and claim your place among the elite egg hunters?</p>`,
