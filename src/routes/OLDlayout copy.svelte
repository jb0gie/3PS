...
<script lang="ts">
	...
	$: slotSidebarLeft = matchPathWhitelist($page.url.pathname) ? 'w-0' : 'variant-glass-surface-token lg:w-auto';
...
<AppShell>
	...
	<slot />
	<br />
	<!-- THE FOOTER LIVES ON THE HOME PAGE -->
	<svelte:fragment slot="pageFooter">
		<DocsFooter/>
	</svelte:fragment>
	<!-- ADD THIS 3D ELEMENT WHEN I CAN FIGURE OUT HOW TO CONTAIN ALL THAT SCROLL -->
	<!-- <Canvas>
		<Scene />
	</Canvas> -->
</AppShell> 
